...
{
    system_gpio_init_output( LR1110_LED_RED_D4_PORT, LR1110_LED_RED_D4_PIN, 0 );
    system_gpio_init_output( LR1110_LED_GREEN_D5_PORT, LR1110_LED_GREEN_D5_PIN, 0 );
    system_gpio_init_output( LR1110_LED_BLUE_D7_PORT, LR1110_LED_BLUE_D7_PIN, 0 );
    system_gpio_init_output( LR1110_LED_AMBER_D6_PORT, LR1110_LED_AMBER_D6_PIN, 0 );
